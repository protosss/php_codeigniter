...
<html>
  ...
  <body>
    ...
    <!--<script src="http://maps.googleapis.com/maps/api/js?v=3&sensor=false&libraries=places&language=th&region=th&callback=initAutocomplete">
    </script>-->
    <script async defer src="https://maps.googleapis.com/maps/api/js?v=3&sensor=false&libraries=places&language=th&region=th&key=AIzaSyAwbIkepM8zG-b1tqY6gcDTUTVQxLJt_Ek&callback=initAutocomplete"
