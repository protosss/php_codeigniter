...
<?php
echo form_open('place/save_place', array('id' => 'frm_place'));
?>
 <div class="row">
          <div class="col-lg-12">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xm-12 col-lg-9">
                        ...
                        <div class="dropdown">
                          <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                            <img id="show_marker" src="<?php //echo $place_marker;?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xm-12 col-lg-9">
                    	<input name="place_id" type="hidden" value="<?php //echo trim($rec['place_id']);?>">
                    	<input name="place_name" type="text" required="required" class="form-control" id="place_name" value="<?php //echo trim($rec['place_name']);?>">
                    </div>                      
                  </div>
                  ...
                  <div class="form-group">                      
                    ...
                    <div class="col-xm-12 col-lg-9">
                    	  <input name="lat_lon" type="text" class="form-control" id="lat_lon" value="<?php //echo trim($rec['place_latitude']);?>, <?php //echo trim($rec['place_longitude']);?>" readonly>
                          <input name="place_latitude" type="hidden" class="form-control" id="place_latitude" value="<?php //echo trim($rec['place_latitude']);?>">
                          <input name="place_longitude" type="hidden" class="form-control" id="place_longitude" value="<?php //echo trim($rec['place_longitude']);?>">
                    </div> 
                  </div>     
                  ...
                  <div class="form-group">                      
                    ...
                    <div class="col-xm-12 col-lg-9">
                            ...
                            <div class="input-group">
                                  <input name="place_zoom" type="text" class="form-control" id="place_zoom" value="<?php //echo trim($rec['place_zoom']);?>" readonly>
                  ...
                  <div class="form-group">                      
                    ...
                    <div class="col-xm-12 col-lg-9">
                    	  <textarea name="place_address" class="form-control" id="place_address"><?php //echo trim($rec['place_address']);?></textarea>
                    </div> 
                  </div>
                  ...
                  <div class="form-group">                      
                    ...
                    <div class="col-xm-12 col-lg-9">
                    	 <input name="place_zipcode" type="text" class="form-control" id="place_zipcode" maxlength="5" value="<?php //echo trim($rec['place_zipcode']);?>">
                    </div> 
                  </div>
                   ...
                   <div class="form-group">                      
                    ...
                    <div class="col-xm-12 col-lg-9">
                    	 <input id="place_tel" name="place_tel" type="text" class="form-control"  value="<?php //echo trim($rec['place_tel']);?>">
                    </div> 
                  </div>
                  ...
                  <div class="form-group">                      
                    ...
                    <div class="col-xm-12 col-lg-9">
                    	<input id="place_fax" name="place_fax" type="text" class="form-control" value="<?php //echo trim($rec['place_fax']);?>">
                    </div> 
                  </div>
                  ...
                  <div class="form-group">                      
                    ...
                    <div class="col-xm-12 col-lg-9">
                    	<input id="place_email" name="place_email" type="text" class="form-control" value="<?php //echo trim($rec['place_email']);?>">
                    </div> 
                  </div>
                  ...
                  <div class="form-group">                      
                    ...
                    <div class="col-xm-12 col-lg-9">
                    	 <input id="place_website" name="place_website" type="text" class="form-control"  value="<?php //echo trim($rec['place_website']);?>">
                    </div> 
                  </div>
                  ...
                  <div class="form-group">                      
                    ...
                    <div class="col-xm-12 col-lg-9">
                    	 <input id="place_facebook" name="place_facebook" type="text" class="form-control"  value="<?php //echo trim($rec['place_facebook']);?>">
                    </div> 
                  </div>
                  ...
                  <div class="form-group">                      
                    ...
                    <div class="col-xm-12 col-lg-9">
                    	 <input id="place_line" name="place_line" type="text" class="form-control"  value="<?php //echo trim($rec['place_line']);?>">
                    </div> 
                  </div>
...
<input type="hidden" name="proc" value="image_to_base64">
